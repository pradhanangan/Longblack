...
public interface IProductVariantService
{
    ...
    Task<IReadOnlyList<ProductVariantDto>> CreateBatchAsync(Guid productId, IReadOnlyList<CreateProductVariantDto> dtos, string createdBy, CancellationToken ct = default);
